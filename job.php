...
<style>:root{--o:#f47a1f;--ink:#202733;--muted:#667085;--line:#e5e7eb}*{box-sizing:border-box}body{margin:0;font-family:Inter,system-ui,-apple-system,"Segoe UI",Arial,sans-serif;background:#f7f8fa;color:var(--ink)}a{text-decoration:none;color:inherit}.wrap{width:min(940px,calc(100% - 32px));margin:auto}header{background:#fff;border-bottom:1px solid var(--line)}.nav{height:70px;display:flex;align-items:center;justify-content:space-between}.brand{font-size:26px;font-weight:800}.brand b{color:var(--o)}.crumb{margin-top:24px;color:#667085;font-size:13px}.card{background:#fff;border:1px solid var(--line);border-radius:16px;padding:32px;margin:14px 0 35px}h1{font-size:34px;line-height:1.2;margin:0 0 9px}.company{font-size:18px;font-weight:700;color:#475467}.meta{display:flex;gap:8px;flex-wrap:wrap;margin:17px 0 24px}.badge{background:#f3f4f6;padding:7px 10px;border-radius:999px;color:#667085;font-size:13px}.desc{white-space:pre-line;line-height:1.75;color:#4b5563}.btn{display:inline-block;background:var(--o);color:#fff;padding:12px 18px;border-radius:9px;font-weight:800;margin-top:24px}.note{font-size:12px;color:#98a2b3;margin-top:12px}@media(max-width:600px){.card{padding:22px}h1{font-size:28px}}</style></head><body><header><div class="wrap nav"><a class="brand" href="/">Jobs<b>Other</b></a><a href="/jobs.html">Find Jobs</a></div></header><main class="wrap"><div class="crumb"><a href="/">Home</a> › <a href="/jobs.html">Jobs</a> › <?=e($title)?></div><article class="card"><h1><?=e($title)?></h1><?php if($company):?><div class="company"><?=e($company)?></div><?php endif?><div class="meta"><?php if($location):?><span class="badge">📍 <?=e($location)?></span><?php endif?><?php if($type):?><span class="badge">🕒 <?=e(str_replace('_',' ',$type))?></span><?php endif?><?php if($created):?><span class="badge">Posted <?=e(substr($created,0,10))?></span><?php endif?></div><h2>Job description</h2><div class="desc"><?=nl2br(e($desc))?></div><?php if($apply):?><a class="btn" href="<?=e($apply)?>" target="_blank" rel="noopener sponsored">Apply at original source ↗</a><div class="note">You will continue your application on the original job provider or employer website.</div><?php endif?></article></main></body></html>